Element(0x00 "DSUB connector, female/male, vertical" "" "DB37F-vert" 1000 3214 1 150 0x00)
(
	# Gehaeuse (schmaler Kasten incl. Bohrungen)
	# Outline

		ElementLine(744 900 744 3588 10)
		ElementLine(744 3588 1256 3588 10)
		ElementLine(1256 900 1256 3588 10)
		ElementLine(744 900 1256 900 10)
	# Pins
