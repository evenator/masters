...
//
//template class Xml::XmlParse<Xml::ABBParse>;
template class Xml::XmlParse<Xml::ABB2Parse>;
//template class Xml::XmlParse<Xml::ASMParse>;
//template class Xml::XmlParse<Xml::optionParse>;
template class Xml::XmlParse<Xml::SurgeryParse>;
